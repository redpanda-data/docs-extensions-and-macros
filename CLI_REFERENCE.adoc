...
`--repo <path>`::
Alternative to --extracted: for properties, a redpanda checkout to extract raw source strings from; for rpk, a streaming-enterprise src/go/rpk checkout to build and run --print-tree against
