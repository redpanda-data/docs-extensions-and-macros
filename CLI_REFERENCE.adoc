...
`--no-partials`::
Skip the generated partials, config snippets, and Bloblang reference because the connect repo publishes them. What's new, diffs, drafts, nav, and the version bump still run
