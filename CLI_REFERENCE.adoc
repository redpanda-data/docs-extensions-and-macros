...
`--repo <url>`::
Repository URL. The default is a private repo, so requires a GitHub token (GH_TOKEN, GITHUB_TOKEN, or REDPANDA_GITHUB_TOKEN) (default: "https://github.com/redpanda-data/streaming-enterprise.git")
