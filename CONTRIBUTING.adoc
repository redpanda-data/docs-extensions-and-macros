...
There is nothing to do by hand. If the tag for a published version is ever missing, rerun the publish workflow: the release step checks npm for the version and creates the tag if it is absent, and leaves an existing release alone.
