...
antora:
  extensions:
  - require: '@redpanda-data/antora-extensions-and-macros/extensions/algolia-indexer/index'
...
antora:
  extensions:
  - '@redpanda-data/antora-extensions-and-macros/extensions/version-fetcher/set-latest-version'
```
...
antora:
  extensions:
  - require: '@redpanda-data/antora-extensions-and-macros/extensions/add-global-attributes'
    org: example
    repo: test
    branch: main
```
...
antora:
  extensions:
  - '@redpanda-data/antora-extensions-and-macros/extensions/replace-attributes-in-attachments'
```
...
antora:
  extensions:
  - require: '@redpanda-data/antora-extensions-and-macros/extensions/unlisted-pages'
...
asciidoc:
  extensions:
    - '@redpanda-data/antora-extensions-and-macros/macros/config-ref'
----
...
asciidoc:
  extensions:
    - '@redpanda-data/antora-extensions-and-macros/macros/glossary'
----
...
asciidoc:
  extensions:
    - '@redpanda-data/antora-extensions-and-macros/macros/helm-ref'
----
