...
- `page-is-nearing-eol`: Indicates if the page is within the warning period before EOL. Calculated using `(page-release-date + eol_months) - warning_weeks`.
- `page-is-past-eol`: Indicates if the page has passed its EOL. Calculated using `today > (page-release-date + eol_months)`.
