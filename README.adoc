...
To enable the `bloblang-samples-extension`, add it to your Antora playbook under the `antora.extensions` key. No additional configuration is required.
