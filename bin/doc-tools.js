...
automation
  ...
  .action((options) => {
    ...
    if (oldTag) {
      ...
      make(oldTag, overridesPath, templates, outputDir, oldTempDir, options.cloudSupport);
    }
    ...
    if (oldTag) {
      ...
      make(newTag, overridesPath, templates, outputDir, newTempDir, options.cloudSupport);
