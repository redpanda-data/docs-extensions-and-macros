...
----
{
  ...
  "is_beta": false,
  "notes_url": "https://github.com/redpanda-data/streaming-enterprise/releases/tag/v25.3.1"
}
----
...
----
{
  ...
  "is_beta": true,
  "notes_url": "https://github.com/redpanda-data/streaming-enterprise/releases/tag/v25.4.1-rc1"
}
----
...
Release notes: https://github.com/redpanda-data/streaming-enterprise/releases/tag/v25.3.1
----
...
https://github.com/redpanda-data/streaming-enterprise/releases
----
